...
2. **[Le diagramme de séquence système (SSD)](#dss)** (+ aperçu des séquences détaillées) : extraire les événements système (acteur → : système), nommer les opérations et comprendre messages/variantes (alt/opt).
3. **[Le diagramme de classes](#classes)** (modèle de domaine) : poser les concepts, attributs, associations avec multiplicités, héritage, agrégation/composition.